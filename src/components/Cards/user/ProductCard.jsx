...
export default function ProductCard({ brandName, image, title, price }) {
    ...
    return (
        <>
            ...
            <Link to='/productDetail'>
                <div class="w-full max-w-sm my-2 bg-gray-400 border border-gray-200 rounded-lg shadow  dark:border-gray-400">
                    <a href=" ">
