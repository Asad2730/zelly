                ...
                <div class="h-56 border-2 border-gray-200 border-opacity-60 rounded-xl overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center flex-wrap justify-between">
                            <a class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0" href=" ">View Shops
                                <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M5 12h14"></path>
                                    <path d="M12 5l7 7-7 7"></path>
                                </svg>
                            </a>
                            <a class="text-green-500 inline-flex items-center md:mb-2 lg:mb-0" href=" ">Add Shops
