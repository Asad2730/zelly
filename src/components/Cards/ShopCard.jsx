...
export default function ShopCard({ id, name, shopType, cnic, shopName, shopNo, onDelete }) {
            ...
            <div class="p-4 md:w-1/3 sm:w-full">
                <div class="h-64 md:h-56 border-2 border-gray-300 border-opacity-60 rounded-xl overflow-hidden">
                    ...
                    <div class="px-8 py-6 bg-white ">
                        ...
                        <h2 class="tracking-widest text-sm title-font font-medium text-gray-400 mb-1">{shopNo}</h2>
