        ...
        <>
            <div className="bg-gray-200 h-full w-full">
                    ...
                    <div className="container px-6 h-16 flex items-center lg:items-stretch justify-between mx-auto">
                        <div className="w-auto flex items-center">
                            <div className="rounded-full relative p-3 flex justify-end text-gray-500 flex items-center relative">
                                <input type="text" className="bg-transparent focus:outline-none text-xs w-0 transition duration-150 ease-in-out absolute left-0 ml-10" placeholder="Type something..." />
                                <svg onclick="searchHandler(this)" xmlns="http://www.w3.org/2000/svg" className="cursor-pointer icon icon-tabler icon-tabler-search" width={20} height={20} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <ul className="flex items-center justify-center h-full">
                            <NavLink to='/floors' activeClassName="active"><li className="cursor-pointer h-full xl:flex items-center text-sm  tracking-normal hidden">Dashboard</li></NavLink>
                            <NavLink to='/shops' activeClassName="active"><li className="cursor-pointer h-full xl:flex items-center text-sm ml-10 tracking-normal hidden hover:text-indigo-700 transition duration-150 ease-in-out">Shops</li></NavLink>
                            ...
                            <NavLink to='/allProducts' activeClassName="active"><li className="cursor-pointer h-full xl:flex items-center text-sm mr-10 tracking-normal hidden hover:text-indigo-700 transition duration-150 ease-in-out">Products</li></NavLink>
                            <NavLink to='#'><li className="cursor-pointer h-full xl:flex items-center text-sm tracking-normal hidden hover:text-indigo-700 transition duration-150 ease-in-out">Sales</li></NavLink>
                        </ul>
                        <div className="h-full xl:flex items-center justify-end hidden relative cursor-pointer" onClick={() => setProfile(!profile)}>
                            {profile && (
                ...
                <nav>
                    ...
                    <div className={show ? " my-10 absolute w-full h-full transform -translate-x-0 z-40 xl:hidden" : "absolute w-full h-full transform -translate-x-full z-40 xl:hidden"} id="mobile-nav" >
                                                    ...
                                                    <li className="text-gray-800 pt-8">
                                                        <div className="flex items-center justify-between">
                                                            <div className="flex items-center">
                                                                ...
                                                                <p className="text-gray-800 xl:text-base md:text-2xl text-base ml-3">Shops</p>
                                                            </div>
                                                        </div>
                                                    </li>
                                                </a>
                                                ...
                                                <li className="text-gray-800 pt-8 cursor-pointer">
                                                    <div className="flex items-center justify-between">
                                                        <div className="flex items-center">
                                                            ...
                                                            <p className="text-gray-800 xl:text-base md:text-2xl text-base ml-3">Sales</p>
                                                        </div>
                                                    </div>
                                                </li>
                                            </NavLink>
