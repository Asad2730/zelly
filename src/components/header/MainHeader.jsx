                ...
                <div className="flex w-full items-center justify-between border-b border-indigo-500 py-6 lg:border-none">
                    <div className="flex items-center">
                        ...
                        <div className="ml-10 hidden space-x-8 lg:block">
                            {navigation.map((link) => (
                                <Link to={link.path}>
                                    <a key={link.name} href={link.href} className="text-base font-medium text-white hover:text-indigo-300">
                                        {link.name}
                                    </a>
                                </Link>
                            ))}
                    ...
                    <div className="ml-10 space-x-4">
                        <Link to='/login'>
                            <a href=" " className="inline-block rounded-md border border-transparent bg-indigo-500 py-2 px-4 text-base font-medium text-white hover:bg-opacity-75">
                                Sign in
                            </a>
                        </Link>
                        <Link to="/signup">
